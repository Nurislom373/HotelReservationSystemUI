  ...
  template: `
    <svg 
      ...
      <ng-container [ngSwitch]="name">
        <!-- Bed icon for logo -->
        <g *ngSwitchCase="'bed'">
          <path d="M7 14c1.66 0 3-1.34 3-3S8.66 8 7 8s-3 1.34-3 3 1.34 3 3 3zm12-11h-8v7h8V3zM7 19c1.1 0 2-.9 2-2H5c0 1.1.9 2 2 2zm14-9v8h-4v-6h-2v6h-4V10H3v9H1v2h22v-2h-2v-9h-2z"/>
        </g>
        ...
        <g *ngSwitchCase="'key'">
          <path d="M17 8h-1V6c0-2.76-2.24-5-5-5S6 3.24 6 6v2H5c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zM12 17c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z"/>
        </g>
